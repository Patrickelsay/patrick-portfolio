...
export const getExpanded = {
  ...
  stats: [
    ...
    { value: '20.8K', label: 'clicks to the directory' },
    { value: '553', label: 'provider listings' },
  ...
  media: {
    ...
    admin: 'getexpanded/admin-dashboard',
    analytics: 'getexpanded/analytics-year',
    discord: 'getexpanded/discord',
    instagram: 'getexpanded/instagram',
    collabs: ['getexpanded/collabs-july', 'getexpanded/collabs-august'],
    podcastClip: 'reels/getexpanded-pod',
  },
}
