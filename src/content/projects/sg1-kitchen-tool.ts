...
export const sg1KitchenTool: Project = {
  ...
  summary: 'A multi-function countertop appliance — bundling three cooking modes without complicating any of them.',
  featured: true,
  blocks: [
    {
      kind: 'text',
    ...
    },
    {
      ...
      intro: 'The form was tested rough first — cardboard and Tim Hortons box lids — before committing to the appearance model.',
      items: [
        { media: 'sg1/proto-cardboard', caption: 'Cardboard rig — proving the hinge and handle geometry' },
        { media: 'sg1/proto-white', caption: 'White model — form and proportion check' },
        { media: 'sg1/proto-lift', caption: 'Testing the plate lift, one hand, no burns' },
        { media: 'sg1/proto-appearance', caption: 'The appearance model — tambour door and rotating dials' },
      ],
    },
    {
      kind: 'text',
