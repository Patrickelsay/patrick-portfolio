...
export const site = {
  ...
  aboutTeaser:
    'Cofounder of GetExpanded, content creator, and Carleton University industrial design grad. Creativity paired with a business-first systems mindset. I think cinematically and build like an operator.',
  cta: {
...
export const domainIntros: Record<string, string> = {
  product:
    'Five years of industrial design at Carleton University: ideation, sketching, 3D CAD, and the full process from research to final model. The foundation under all of it: design is problem solving.',
